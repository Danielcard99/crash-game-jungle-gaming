...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RocketCrash — Aposte. Suba. Saque." },
      {
        name: "description",
        content:
          "Crash game em tempo real. Aposte, veja o foguete subir e saque antes que ele exploda.",
      },
      { property: "og:title", content: "RocketCrash — Aposte. Suba. Saque." },
      {
      ...
      { property: "og:site_name", content: "RocketCrash" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "RocketCrash — Aposte. Suba. Saque." },
      {
